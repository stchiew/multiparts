...
export interface IHeaderPartState {
  isMounted?: boolean;
}

export default class HeaderPart extends React.Component<IHeaderPartProps, IHeaderPartState> {
  ...
  constructor(props: IHeaderPartProps) {
    super(props);
  ...
  public componentWillUpdate(nextProps: IHeaderPartProps) {
